...
export default function Texnika() {
  ...
  const handleSendToRepair = async (user) => {
    try {
      ...
      // Agar username mavjud bo'lsa, uni user obyektiga qo'shamiz
      if (username) {
  ...
  const handleSendToUnused = async (user) => {
    try {
      ...
      // texnika_unused endpoint'iga so'rov yuborish
    ...
    <div className="users-container">
      <div className="users-header">
        ...
        <div className="controls">
          ...
          <button className="add-user-button" onClick={() => setAddtexnika(true)}>
